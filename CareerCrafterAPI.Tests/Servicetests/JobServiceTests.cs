...
namespace CareerCrafterAPI.Tests.Servicetests
{
    ...
    .Returns(new JobResponseDto
    {
        ...
        [Test]
        public void AddJobAsync_ThrowsException_WhenEmployerProfileIncomplete()
        {
            var dto = new JobCreateDto
            {
                EmployerId = 1,
            ...
            _mockRepository
                .Setup(r => r.EmployerExistsAsync(1))
                .ReturnsAsync(true);
        ...
        [Test]
        public void AddJobAsync_ThrowsException_WhenDeadlineIsPast()
        {
            var dto = new JobCreateDto
            {
                EmployerId = 1,
        ...
        [Test]
        public async Task RestoreJobAsync_ReturnsTrue_WhenJobExists()
        {
            var job = new Job
            {
                JobId = 1,
            ...
            _mockRepository
                .Setup(r => r.RestoreJobAsync(job))
                .Returns(Task.CompletedTask);

            var result =
                await _jobService.RestoreJobAsync(1);

            Assert.IsTrue(result);

            _mockRepository.Verify(
                r => r.RestoreJobAsync(It.IsAny<Job>()),
                Times.Once);
        }

        [Test]
        public async Task RestoreJobAsync_ReturnsFalse_WhenJobNotFound()
        {
            _mockRepository
            ...
            var result =
                await _jobService.RestoreJobAsync(99);
        ...
        [Test]
        public async Task GetJobsByEmployerIdAsync_ReturnsJobs()
        {
            ...
            _mockRepository
                .Setup(r => r.GetJobsByEmployerIdAsync(1))
                .ReturnsAsync(jobs);
            ...
            var result =
                await _jobService.GetJobsByEmployerIdAsync(1);

            Assert.IsNotNull(result);

            Assert.That(result.Count, Is.EqualTo(1));

            Assert.That(result[0].JobTitle,
                Is.EqualTo("DotNet Developer"));
        }

        [Test]
        public async Task GetArchivedJobsByEmployerIdAsync_ReturnsJobs()
        {
            var jobs = new List<Job>
            {
                new Job
            ...
            _mockRepository
                .Setup(r => r.GetArchivedJobsByEmployerIdAsync(1))
                .ReturnsAsync(jobs);
            ...
            var result =
                await _jobService.GetArchivedJobsByEmployerIdAsync(1);
        ...
        [Test]
        public void UpdateJobAsync_ThrowsException_WhenDeadlineIsPast()
        {
            var job = new Job
            {
                JobId = 1,
            ...
            _mockRepository.Verify(
                r => r.UpdateJobAsync(It.IsAny<Job>()),
                Times.Never);
        }
            ...
            var jobs = new List<Job>
    {
        new Job
        {
            ...
            var result = await _jobService.GetJobsPagedAsync(1, 1, 10, null, false);
